...
$CAFFE_ROOT_DIR/build/tools/caffe train \
    ...
    --snapshot=$CAFFE_ROOT_DIR/models/kaggle_cats_dogs_caffenet/caffenet_train_iter_1041.solverstate >> $CAFFE_ROOT_DIR/models/kaggle_cats_dogs_caffenet/caffe_caffenet_train.log 2>&1 \
